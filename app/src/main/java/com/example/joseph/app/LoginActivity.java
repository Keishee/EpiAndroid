...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Check previous login info
        SharedPreferences prefs = getPreferences(MODE_PRIVATE);
        String previousLogin = prefs.getString("login", null);
        String previousPassword = prefs.getString("password", null);
...
//        populateAutoComplete();
        ...
        if (previousLogin != null && previousPassword != null) {
            mEmailView.setText(previousLogin);
            mPasswordView.setText(previousPassword);
        }
...
//                JsonObject object = wtf.getAsJsonObject();
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                myIntent.setClass(getApplicationContext(), FrontPageActivity.class);
